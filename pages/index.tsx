...
const Home: NextPage = () => {
  return (
    // <div className="bg-slate-400 dark xl:place-content-center py-20 px-20 grid gap-10 lg:grid-col-2 xl:grid-cols-3 min-h-screen">
    ...
    //     </div>
    //     <button className="mt-5 bg-blue-500 dark:bg-black dark:border-white dark:border text-white p-3 text-center rounded-xl w-3/4 mx-auto
    ...
    //         </div>
    //         <div className="h-24 w-24 bg-zinc-300 rounded-full group-hover:bg-red-300"></div>
    //         <div className="flex flex-col items-center">
